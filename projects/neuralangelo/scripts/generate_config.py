...
def generate_config(args):
    ...
    num_images = len(os.listdir(os.path.join(args.data_dir, "images/images_raw")))
    # model cfg
    ...
    img = Image.open(os.path.join(args.data_dir, "images/images_raw", os.listdir(os.path.join(args.data_dir, "images/images_raw"))[0]))
    w, h = img.size
